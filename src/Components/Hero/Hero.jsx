...
import hero_1 from "../Assests/videos/hero-1.mp4";
import hero_2 from "../Assests/videos/hero-2.mp4";
import hero_3 from "../Assests/videos/hero-3.mp4";
import hero_4 from "../Assests/videos/hero-4.mp4";
...
export default function () {
  ...
  const getVideoSource = (index) => {
    const safeIndex = index % totalVideos;
  ...
  useGSAP(()=>{
    gsap.set('#video-frame',{
      clipPath: 'polygon(14% 0%, 72% 0%, 90% 88%, 0% 100%)',
